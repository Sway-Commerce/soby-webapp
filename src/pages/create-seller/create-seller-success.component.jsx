...
const CreateSellerSuccess = function () {
  return (
    <div className='d-flex justify-content-center' style={{ border: '1px black' }}>
      <div style={{ width: '480px', textAlign: 'center', border: '1px black', alignItems: 'center' }}>
        ...
        <div style={{ alignItems: 'center', marginTop: '20px' }}>
          <img
            style={{ verticalAlign: 'middle', display: 'inline-block', padding: '4px' }}
            src={AndroidDownload}
            onClick={() => window.open('https://play.google.com/store/apps/details?id=com.vn.soby&ah=XEe68UIQAM9wiZLtLjBCsOqeHng')}
          />
        ...
        <div style={{ marginTop: '90px', marginBottom: '30px' }}>
          <Link to='/'>
            <span className='' style={{ fontSize: '14px', color: '#6E7678' }}>
              Back to homepage
            </span>
          </Link>
        </div>
